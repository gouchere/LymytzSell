...
//        try {
//            if (serverOnline("commercial")) {
//                page.IMG_WIFI.setImage(new Image(LocalLoader.class.getResourceAsStream("/icones/i_wifi_connect.png")));
//                DefaultClientConfig config = new DefaultClientConfig();
//                config.getClasses().add(JacksonJsonProvider.class);
//                Client clt = Client.create(config);
...
//                }
//            } else {
//                page.IMG_WIFI.setImage(new Image(LocalLoader.class.getResourceAsStream("/icones/i_wifi_disconnect.png")));
//            }
//        } catch (Exception ex) {
//            ex.printStackTrace();
//        }
