...
//            File f = new File(LocalLoader.class.getResourceAsStream("/icones/produits.png"));
//            if (f.exists()) {
//                try {
//                    Image img = new Image(new FileInputStream(f));
//                    return img;
...
////            return img;
////        } catch (FileNotFoundException ex) {
////            File f = new File(LocalLoader.class.getResourceAsStream("/view/icones/produits.png"));
////            if (f.exists()) {
////                try {
////                    Image img = new Image(new FileInputStream(f));
////                    return img;
...
//        i1 = new ImageView(new Image(LocalLoader.class.getResourceAsStream("/icones/add1.png")));
//        BUT_PPTE = new ImageView(new Image(LocalLoader.class.getResourceAsStream("/icones/info.png")));
