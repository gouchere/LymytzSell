...
public class DateTimePickerSkin_OLD extends ComboBoxPopupControl<LocalDateTime> {

    private DateTimePicker_OLD datePicker;
    private TextField displayNode;
    private DateTimePickerContent datePickerContent;

    public DateTimePickerSkin_OLD(final DateTimePicker_OLD datePicker) {
...
//             }
    ...
    @Override protected TextField getEditor() {
        ...
        return ((DateTimePicker_OLD)getSkinnable()).getEditor();
    }

    @Override protected StringConverter<LocalDateTime> getConverter() {
        return ((DateTimePicker_OLD)getSkinnable()).getConverter();
    }
