...
public class DateTimePicker_OLD extends ComboBoxBase<LocalDateTime> {
...
//                defaultConverter = new LocalDateStringConverter(FormatStyle.SHORT, null, chrono);
                defaultConverter = new CustomConvertDP();
            } else {
...
/**
    ...
    public DateTimePicker_OLD(LocalDateTime localDate) {
        setValue(localDate);
...
/**
    ...
    private ObjectProperty<Callback<DateTimePicker_OLD, DateTimeCell>> dayCellFactory;
    public final void setDayCellFactory(Callback<DateTimePicker_OLD, DateTimeCell> value) {
        dayCellFactoryProperty().set(value);
    }
    public final Callback<DateTimePicker_OLD, DateTimeCell> getDayCellFactory() {
        return (dayCellFactory != null) ? dayCellFactory.get() : null;
    }
    public final ObjectProperty<Callback<DateTimePicker_OLD, DateTimeCell>> dayCellFactoryProperty() {
        if (dayCellFactory == null) {
            dayCellFactory = new SimpleObjectProperty<Callback<DateTimePicker_OLD, DateTimeCell>>(this, "dayCellFactory");
        }
    ...
    public final BooleanProperty showWeekNumbersProperty() {
        if (showWeekNumbers == null) {
            ...
            showWeekNumbers = new StyleableBooleanProperty(localizedDefault) {
                @Override public CssMetaData<DateTimePicker_OLD,Boolean> getCssMetaData() {
                    return StyleableProperties.SHOW_WEEK_NUMBERS;
                }

                @Override public Object getBean() {
                    return DateTimePicker_OLD.this;
                }
...
/**
    ...
    private StringConverter<LocalDateTime> defaultConverter =new CustomConvertDP();
//                new LocalDateTimeStringConverter(FormatStyle.SHORT, null, getChronology());
...
/**
    ...
    @Override protected Skin<?> createDefaultSkin() {
        return new DateTimePickerSkin_OLD(this);
    }
...
/**
    ...
    private static class StyleableProperties {
        ...
        private static final CssMetaData<DateTimePicker_OLD, Boolean> SHOW_WEEK_NUMBERS =
              new CssMetaData<DateTimePicker_OLD, Boolean>("-fx-show-week-numbers",
                   BooleanConverter.getInstance(),
                   (!country.isEmpty() &&
                    ControlResources.getNonTranslatableString("DatePicker.showWeekNumbers").contains(country))) {
            @Override public boolean isSettable(DateTimePicker_OLD n) {
                return n.showWeekNumbers == null || !n.showWeekNumbers.isBound();
            }

            @Override public StyleableProperty<Boolean> getStyleableProperty(DateTimePicker_OLD n) {
