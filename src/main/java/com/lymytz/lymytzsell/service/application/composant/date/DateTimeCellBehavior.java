...
/**************************************************************************
    ...
    protected static final List<KeyCodeCombination> DATE_CELL_BINDINGS = new ArrayList<KeyCodeCombination>();
    static {
        DATE_CELL_BINDINGS.add(new KeyCodeCombination(UP, "TraverseUp"));
